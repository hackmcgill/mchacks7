...
const Logos = ({ scrollRef }) => (
  <Container ref={scrollRef}>
    ...
    <Content style={{ justifyContent: "space-evenly", justifyItems: "center" }}>
      <NavLink href="https://rbc.ca/" target="_blank">
        <Image src={rbc} style={{ minWidth: "100%" }} />
      </NavLink>
      <NavLink href="https://www.ivey.uwo.ca" target="_blank">
        <Image src={ivey} style={{ minWidth: "100%" }} />
      </NavLink>
    </Content>
    <Content style={{ justifyContent: "space-evenly", textAlign: "center" }}>
      <NavLink href="https://www.nuance.com/index.html" target="_blank">
    ...
    <Content style={{ justifyContent: "space-evenly" }}>
      <NavLink
        href="https://careers.microsoft.com/students/ca/en/"
        target="_blank"
      >
    ...
    <Content style={{ justifyContent: "space-evenly" }}>
      <NavLink href="https://www.ibm.com/ca-en" target="_blank">
        <Image
          src={ibm}
          style={{ width: "100%", maxWidth: "250px", height: "50px" }}
        />
    ...
    <Content style={{ justifyContent: "space-evenly", alignItems: "center" }}>
      <NavLink href="https://www.tandemlaunch.com/en/careers/" target="_blank">
        <Image
    ...
    <Content style={{ justifyContent: "space-evenly" }}>
      <NavLink href="https://www.wolframalpha.com" target="_blank">
        <Image src={wolfram} style={{ width: "100%", maxWidth: "50px" }} />
      </NavLink>
      ...
      <NavLink href="https://www.netlify.com" target="_blank">
        <Image style={{ width: "100%", maxWidth: "50px" }} />
        {/* Need a logo for them */}
      </NavLink>
      <NavLink href="https://www.voiceflow.com" target="_blank">
        <Image src={voiceflow} style={{ width: "100%", maxWidth: "75px" }} />
      </NavLink>
      <NavLink href="https://www.twilio.com/company/jobs" target="_blank">
