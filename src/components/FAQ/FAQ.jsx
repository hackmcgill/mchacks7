...
const FAQ = ({ scrollRef }) => (
  <Container ref={scrollRef}>
    ...
    <Question question="Do I need a team?">
      While you do have the option of working alone, McHacks is a team event so working with others is encouraged. There are a few ways to find teammates: You can pick your team from people you already know, or meet them at group formation session during the hackathon.
    </Question>
